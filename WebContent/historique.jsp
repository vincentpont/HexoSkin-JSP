...
<br>
				<div class="table-responsive">
					<table class="table table-striped sortable">
						<thead>
							<tr>
								<th> <span style="font-size:22pt;" class="glyphicon glyphicon-calendar"> Date</span> </th>
								<th> <span style="font-size:22pt;" class="glyphicon glyphicon-time"> Time</span> </th>
								<th> <span style="font-size:22pt;" class="glyphicon glyphicon-sort"> Distance</span> </th>
								<th> <span style="font-size:22pt;" class="glyphicon glyphicon-fire"> Calories</span> </th>
								<th> <span style="font-size:22pt;" class="glyphicon glyphicon-signal"> Mètre/min</span> </th>
							</tr>
						</thead>
						<tbody style="font-size:14pt; font-family:Verdana;">
